...
const isWideSidebar = Variable(false);
...
const toggleSidebarWidth = () => {
    isWideSidebar.value = !isWideSidebar.value;
    const sideLeft = App.getWindow('sideleft');
    if (sideLeft) {
    ...
    children: [
        Button({
            ...
            onClicked: () => {
                ...
                if (surahListRevealer && surahListRevealer.revealChild && !isWideSidebar.value) {
                    toggleSidebarWidth();
                } else if (!surahListRevealer || !surahListRevealer.revealChild && isWideSidebar.value) {
                    toggleSidebarWidth();
                }
            },
            setup: setupCursorHover,
