...
const pinButton = Button({
    attribute: {
        ...
        toggle: (self) => {
            ...
            sideleftContent.toggleClassName(
                "sidebar-pinned",
        ...
        setup: (self) =>
            self.on("key-press-event", (widget, event) => {
                ...
                if (
                    checkKeybind(
                        event,
                        userOptions.asyncGet().keybinds.sidebar.pin,
                    )
                )
                    ...
                    checkKeybind(
                        event,
                        userOptions.asyncGet().keybinds.sidebar.cycleTab,
                    )
                )
                    ...
                    checkKeybind(
                        event,
                        userOptions.asyncGet().keybinds.sidebar.nextTab,
                    )
                )
                    ...
                    checkKeybind(
                        event,
                        userOptions.asyncGet().keybinds.sidebar.prevTab,
                    )
                )
                    widgetContent.prevTab();

                if (
                    widgetContent.attribute.names[
                    ...
                    // Switch API type
                        ...
                        checkKeybind(
                            event,
                            userOptions.asyncGet().keybinds.sidebar.apis
                                .nextTab,
                        )
                    ) {
                        const toSwitchTab =
