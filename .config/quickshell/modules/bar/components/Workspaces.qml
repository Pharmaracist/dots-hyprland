...
Item {
    ...
    readonly property HyprlandMonitor monitor: bar?.screen ? Hyprland.monitorFor(bar.screen) : null
    ...
    property double animatedActiveWorkspaceIndex: ((monitor?.activeWorkspace?.id || 1) - 1) % ConfigOptions.bar.workspaces.shown
